...
📄 **[Read the full PRD →](./prd-cms-platform-migration.md)**
...
|---|---|
| [PRD: E-Commerce CMS Platform Migration](https://github.com/thedmons/prd-ecommerce-cms-migration) | Related platform migration PRD — different domain (e-commerce vs. fintech), similar migration pattern |
